...
//! ## Filtering Features
//!
//! By default filtering features remove from the full set of emojis.
//!
//! When enabling the `additive` feature, the set of emojis start empty and the filtering features add to the set.
//!
//! ### Modifiers
//!
